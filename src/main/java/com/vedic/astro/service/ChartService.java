...
public class ChartService {
	...
	public List<ChartHouseDTO> getChart2(BirthChartType chartType, String memberId) {
		...
		chartHouseDTOList
				.add(new ChartHouseDTO(House.H1, new HouseContentDTO(3, h1Planets, h1Naks, h1Longs, 3, Planet.MER)));
		...
		chartHouseDTOList
				.add(new ChartHouseDTO(House.H5, new HouseContentDTO(7, h5Planets, h5Naks, h5Longs, 2, Planet.VEN)));
		chartHouseDTOList
				.add(new ChartHouseDTO(House.H6, new HouseContentDTO(8, h6Planets, h6Naks, h6Longs, 12, Planet.MAR)));
		chartHouseDTOList
				.add(new ChartHouseDTO(House.H7, new HouseContentDTO(9, h7Planets, h7Naks, h7Longs, 10, Planet.JUP)));
		...
		chartHouseDTOList.add(
				new ChartHouseDTO(House.H12, new HouseContentDTO(2, h12Planets, h12Naks, h12Longs, 11, Planet.VEN)));
	...
	public List<ChartHouseDTO> getChart(BirthChartType chartType, String memberId) {
		...
		if (birthChartDataOpt.isPresent()) {
			...
			for (House house : House.values()) {
				...
				chartHouseDTOList
				.add(new ChartHouseDTO(house, new HouseContentDTO(zodiac.getNumber(), planets, naks, longs, arudhaNumber, lord)));
